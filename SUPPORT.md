...
Thanks for using peru_species_project! Before filing an issue, there are
a few places to explore and pieces to put together to make the process
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/PaulESantos/peru_species_project/issues/new).
...
requests](https://github.com/PaulESantos/peru_species_project/issues) to
