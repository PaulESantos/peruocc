...
#> ℹ Procesando 1 lote(s) espaciales. Checkpoints en: 'D:/peruocc/peruocc-output/cache/consultas_ocurrencias'
...
#> ℹ [GBIF] Consultando registros dentro del polígono de MIRAFLORES (límite: "200")...
#> ✔ [GBIF] Búsqueda finalizada. Se filtraron 198 registro(s) que caen dentro del polígono seleccionado.
#> ℹ [iNaturalist] Iniciando búsqueda de ocurrencias...
#> ℹ [iNaturalist] Filtrando por reino Plantae (Flora).
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de MIRAFLORES (límite: "200")...
#> ℹ [iNaturalist] Se descargaron 200 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 167 de 200 registros caen dentro del polígono seleccionado.
...
#> ℹ Cargando límites de CUSCO desde el caché local...
#> ℹ Procesando 8 lote(s) espaciales. Checkpoints en: 'D:/peruocc/peruocc-output/cache/consultas_ocurrencias'
#> ℹ [GBIF] Iniciando búsqueda de ocurrencias...
#> ✔ Polígono simplificado con éxito a tolerancia de 100 metros (WKT: 1026 caracteres).
#> ℹ [GBIF] Filtrando por reino Animalia (Fauna).
#> ℹ [GBIF] Consultando registros dentro del polígono de SANTIAGO (límite: "200")...
#> ✔ [GBIF] Búsqueda finalizada. Se filtraron 200 registro(s) que caen dentro del polígono seleccionado.
#> ℹ [iNaturalist] Iniciando búsqueda de ocurrencias...
#> ℹ [iNaturalist] Filtrando por reino Animalia (Fauna).
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de SANTIAGO (límite: "200")...
#> ℹ [iNaturalist] Se descargaron 200 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 87 de 200 registros caen dentro del polígono seleccionado.
#> ℹ [GBIF] Iniciando búsqueda de ocurrencias...
#> ℹ [GBIF] Filtrando por reino Animalia (Fauna).
#> ℹ [GBIF] Consultando registros dentro del polígono de WANCHAQ (límite: "200")...
#> ✔ [GBIF] Búsqueda finalizada. Se filtraron 200 registro(s) que caen dentro del polígono seleccionado.
#> ℹ [iNaturalist] Iniciando búsqueda de ocurrencias...
#> ℹ [iNaturalist] Filtrando por reino Animalia (Fauna).
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de WANCHAQ (límite: "200")...
#> ℹ [iNaturalist] Se descargaron 200 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 95 de 200 registros caen dentro del polígono seleccionado.
#> ℹ [GBIF] Iniciando búsqueda de ocurrencias...
#> ✔ Polígono simplificado con éxito a tolerancia de 300 metros (WKT: 550 caracteres).
#> ℹ [GBIF] Filtrando por reino Animalia (Fauna).
#> ℹ [GBIF] Consultando registros dentro del polígono de CCORCA (límite: "200")...
#> ✔ [GBIF] Búsqueda finalizada. Se filtraron 200 registro(s) que caen dentro del polígono seleccionado.
#> ℹ [iNaturalist] Iniciando búsqueda de ocurrencias...
#> ℹ [iNaturalist] Filtrando por reino Animalia (Fauna).
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de CCORCA (límite: "200")...
#> ℹ [iNaturalist] Se descargaron 28 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 3 de 28 registros caen dentro del polígono seleccionado.
#> ℹ [GBIF] Iniciando búsqueda de ocurrencias...
#> ✔ Polígono simplificado con éxito a tolerancia de 100 metros (WKT: 1027 caracteres).
#> ℹ [GBIF] Filtrando por reino Animalia (Fauna).
#> ℹ [GBIF] Consultando registros dentro del polígono de SAN SEBASTIAN (límite: "200")...
#> ✔ [GBIF] Búsqueda finalizada. Se filtraron 200 registro(s) que caen dentro del polígono seleccionado.
#> ℹ [iNaturalist] Iniciando búsqueda de ocurrencias...
#> ℹ [iNaturalist] Filtrando por reino Animalia (Fauna).
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de SAN SEBASTIAN (límite: "200")...
#> ℹ [iNaturalist] Se descargaron 200 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 16 de 200 registros caen dentro del polígono seleccionado.
#> ℹ [GBIF] Iniciando búsqueda de ocurrencias...
#> ✔ Polígono simplificado con éxito a tolerancia de 100 metros (WKT: 741 caracteres).
#> ℹ [GBIF] Filtrando por reino Animalia (Fauna).
#> ℹ [GBIF] Consultando registros dentro del polígono de SAYLLA (límite: "200")...
#> ✔ [GBIF] Búsqueda finalizada. Se filtraron 200 registro(s) que caen dentro del polígono seleccionado.
#> ℹ [iNaturalist] Iniciando búsqueda de ocurrencias...
#> ℹ [iNaturalist] Filtrando por reino Animalia (Fauna).
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de SAYLLA (límite: "200")...
#> ℹ [iNaturalist] Se descargaron 200 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 29 de 200 registros caen dentro del polígono seleccionado.
#> ℹ [GBIF] Iniciando búsqueda de ocurrencias...
#> ✔ Polígono simplificado con éxito a tolerancia de 100 metros (WKT: 448 caracteres).
#> ℹ [GBIF] Filtrando por reino Animalia (Fauna).
#> ℹ [GBIF] Consultando registros dentro del polígono de POROY (límite: "200")...
#> ✔ [GBIF] Búsqueda finalizada. Se filtraron 199 registro(s) que caen dentro del polígono seleccionado.
#> ℹ [iNaturalist] Iniciando búsqueda de ocurrencias...
#> ℹ [iNaturalist] Filtrando por reino Animalia (Fauna).
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de POROY (límite: "200")...
#> ℹ [iNaturalist] Se descargaron 12 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 5 de 12 registros caen dentro del polígono seleccionado.
#> ℹ [GBIF] Iniciando búsqueda de ocurrencias...
#> ✔ Polígono simplificado con éxito a tolerancia de 100 metros (WKT: 1340 caracteres).
#> ℹ [GBIF] Filtrando por reino Animalia (Fauna).
#> ℹ [GBIF] Consultando registros dentro del polígono de SAN JERONIMO (límite: "200")...
#> ✔ [GBIF] Búsqueda finalizada. Se filtraron 199 registro(s) que caen dentro del polígono seleccionado.
#> ℹ [iNaturalist] Iniciando búsqueda de ocurrencias...
#> ℹ [iNaturalist] Filtrando por reino Animalia (Fauna).
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de SAN JERONIMO (límite: "200")...
#> ℹ [iNaturalist] Se descargaron 200 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 143 de 200 registros caen dentro del polígono seleccionado.
#> ℹ [GBIF] Iniciando búsqueda de ocurrencias...
...
#> ℹ [iNaturalist] Se descargaron 200 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 166 de 200 registros caen dentro del polígono seleccionado.
...
#>    occurrenceID sourceRecordID sourceURL        datasetKey license basisOfRecord
#>    <chr>        <chr>          <chr>            <chr>      <chr>   <chr>        
#>  1 6130955903   6130955903     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  2 6147676011   6147676011     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  3 6147584943   6147584943     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  4 6147634578   6147634578     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  5 6171147726   6171147726     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  6 6452273700   6452273700     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  7 6195560404   6195560404     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  8 6414124325   6414124325     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  9 6481433622   6481433622     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#> 10 5087130717   5087130717     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#> # ℹ 2,131 more rows
#> # ℹ 18 more variables: scientificName <chr>, decimalLatitude <dbl>,
#> #   decimalLongitude <dbl>, eventDate <chr>, taxonRank <chr>, kingdom <chr>,
#> #   phylum <chr>, class <chr>, order <chr>, family <chr>, genus <chr>,
...
#> ℹ [GBIF] Consultando registros dentro del polígono de TAMBOPATA (límite: "100")...
#> ✔ [GBIF] Búsqueda finalizada. Se filtraron 21 registro(s) que caen dentro del polígono seleccionado.
#> ℹ [iNaturalist] Iniciando búsqueda de ocurrencias...
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de TAMBOPATA (límite: "100")...
#> ℹ [iNaturalist] Se descargaron 100 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 15 de 100 registros caen dentro del polígono seleccionado.
...
#> ℹ Cargando límites de CUSCO desde el caché local...
#> ℹ Cargando límites de CUSCO desde el caché local...
#> ℹ Procesando 10 lote(s) espaciales. Checkpoints en: 'D:/peruocc/peruocc-output/cache/consultas_ocurrencias'
#> ℹ [GBIF] Iniciando búsqueda de ocurrencias...
#> ✔ Polígono simplificado con éxito a tolerancia de 100 metros (WKT: 1213 caracteres).
#> ℹ [GBIF] Filtrando por reino Plantae (Flora).
#> ℹ [GBIF] Consultando registros dentro del polígono de MARAS (límite: "300")...
#> ✔ [GBIF] Búsqueda finalizada. Se filtraron 294 registro(s) que caen dentro del polígono seleccionado.
#> ℹ [iNaturalist] Iniciando búsqueda de ocurrencias...
#> ℹ [iNaturalist] Filtrando por reino Plantae (Flora).
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de MARAS (límite: "300")...
#> ℹ [iNaturalist] Se descargaron 300 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 196 de 300 registros caen dentro del polígono seleccionado.
#> ℹ [GBIF] Iniciando búsqueda de ocurrencias...
#> ✔ Polígono simplificado con éxito a tolerancia de 100 metros (WKT: 1211 caracteres).
#> ℹ [GBIF] Filtrando por reino Plantae (Flora).
#> ℹ [GBIF] Consultando registros dentro del polígono de HUAYLLABAMBA (límite: "300")...
#> ✔ [GBIF] Búsqueda finalizada. Se filtraron 300 registro(s) que caen dentro del polígono seleccionado.
#> ℹ [iNaturalist] Iniciando búsqueda de ocurrencias...
#> ℹ [iNaturalist] Filtrando por reino Plantae (Flora).
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de HUAYLLABAMBA (límite: "300")...
#> ℹ [iNaturalist] Se descargaron 300 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 143 de 300 registros caen dentro del polígono seleccionado.
#> ℹ [GBIF] Iniciando búsqueda de ocurrencias...
#> ✔ Polígono simplificado con éxito a tolerancia de 100 metros (WKT: 608 caracteres).
#> ℹ [GBIF] Filtrando por reino Plantae (Flora).
#> ℹ [GBIF] Consultando registros dentro del polígono de YUCAY (límite: "300")...
#> ✔ [GBIF] Búsqueda finalizada. Se filtraron 300 registro(s) que caen dentro del polígono seleccionado.
#> ℹ [iNaturalist] Iniciando búsqueda de ocurrencias...
#> ℹ [iNaturalist] Filtrando por reino Plantae (Flora).
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de YUCAY (límite: "300")...
#> ℹ [iNaturalist] Se descargaron 275 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 136 de 275 registros caen dentro del polígono seleccionado.
#> ℹ [GBIF] Iniciando búsqueda de ocurrencias...
#> ✔ Polígono simplificado con éxito a tolerancia de 100 metros (WKT: 865 caracteres).
#> ℹ [GBIF] Filtrando por reino Plantae (Flora).
#> ℹ [GBIF] Consultando registros dentro del polígono de CHINCHERO (límite: "300")...
#> ✔ [GBIF] Búsqueda finalizada. Se filtraron 300 registro(s) que caen dentro del polígono seleccionado.
#> ℹ [iNaturalist] Iniciando búsqueda de ocurrencias...
#> ℹ [iNaturalist] Filtrando por reino Plantae (Flora).
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de CHINCHERO (límite: "300")...
#> ℹ [iNaturalist] Se descargaron 300 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 229 de 300 registros caen dentro del polígono seleccionado.
#> ℹ [GBIF] Iniciando búsqueda de ocurrencias...
#> ✔ Polígono simplificado con éxito a tolerancia de 300 metros (WKT: 898 caracteres).
#> ℹ [GBIF] Filtrando por reino Plantae (Flora).
#> ℹ [GBIF] Consultando registros dentro del polígono de OLLANTAYTAMBO (límite: "300")...
#> ✔ [GBIF] Búsqueda finalizada. Se filtraron 195 registro(s) que caen dentro del polígono seleccionado.
#> ℹ [iNaturalist] Iniciando búsqueda de ocurrencias...
#> ℹ [iNaturalist] Filtrando por reino Plantae (Flora).
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de OLLANTAYTAMBO (límite: "300")...
#> ℹ [iNaturalist] Se descargaron 300 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 44 de 300 registros caen dentro del polígono seleccionado.
#> ℹ [GBIF] Iniciando búsqueda de ocurrencias...
...
#> ℹ [GBIF] Filtrando por reino Plantae (Flora).
#> ℹ [GBIF] Consultando registros dentro del polígono de OLLANTAYTAMBO (límite: "300")...
#> ✔ [GBIF] Búsqueda finalizada. Se filtraron 126 registro(s) que caen dentro del polígono seleccionado.
#> ℹ [iNaturalist] Iniciando búsqueda de ocurrencias...
#> ℹ [iNaturalist] Filtrando por reino Plantae (Flora).
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de OLLANTAYTAMBO (límite: "300")...
#> ℹ [iNaturalist] No se encontraron ocurrencias en la caja delimitadora.
#> ℹ [GBIF] Iniciando búsqueda de ocurrencias...
...
#> ℹ [iNaturalist] Filtrando por reino Plantae (Flora).
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de OLLANTAYTAMBO (límite: "300")...
#> ℹ [iNaturalist] Se descargaron 257 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 195 de 257 registros caen dentro del polígono seleccionado.
#> ℹ [GBIF] Iniciando búsqueda de ocurrencias...
#> ✔ Polígono simplificado con éxito a tolerancia de 300 metros (WKT: 897 caracteres).
#> ℹ [GBIF] Filtrando por reino Plantae (Flora).
#> ℹ [GBIF] Consultando registros dentro del polígono de MACHUPICCHU (límite: "300")...
#> ✔ [GBIF] Búsqueda finalizada. Se filtraron 299 registro(s) que caen dentro del polígono seleccionado.
#> ℹ [iNaturalist] Iniciando búsqueda de ocurrencias...
#> ℹ [iNaturalist] Filtrando por reino Plantae (Flora).
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de MACHUPICCHU (límite: "300")...
#> ℹ [iNaturalist] Se descargaron 300 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 286 de 300 registros caen dentro del polígono seleccionado.
#> ℹ [GBIF] Iniciando búsqueda de ocurrencias...
#> ✔ Polígono simplificado con éxito a tolerancia de 100 metros (WKT: 1466 caracteres).
#> ℹ [GBIF] Filtrando por reino Plantae (Flora).
#> ℹ [GBIF] Consultando registros dentro del polígono de URUBAMBA (límite: "300")...
#> ✔ [GBIF] Búsqueda finalizada. Se filtraron 299 registro(s) que caen dentro del polígono seleccionado.
#> ℹ [iNaturalist] Iniciando búsqueda de ocurrencias...
#> ℹ [iNaturalist] Filtrando por reino Plantae (Flora).
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de URUBAMBA (límite: "300")...
#> ℹ [iNaturalist] Se descargaron 300 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 213 de 300 registros caen dentro del polígono seleccionado.
...
#>    occurrenceID sourceRecordID sourceURL        datasetKey license basisOfRecord
#>    <chr>        <chr>          <chr>            <chr>      <chr>   <chr>        
#>  1 6129994865   6129994865     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  2 6133077300   6133077300     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  3 6133103490   6133103490     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  4 6133145835   6133145835     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  5 6133173410   6133173410     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  6 6133262570   6133262570     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  7 6133393442   6133393442     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  8 6133461000   6133461000     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  9 6171289527   6171289527     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#> 10 6178591915   6178591915     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#> # ℹ 4,341 more rows
#> # ℹ 18 more variables: scientificName <chr>, decimalLatitude <dbl>,
#> #   decimalLongitude <dbl>, eventDate <chr>, taxonRank <chr>, kingdom <chr>,
#> #   phylum <chr>, class <chr>, order <chr>, family <chr>, genus <chr>,
...
#> ℹ [GBIF] Iniciando búsqueda de ocurrencias...
#> ℹ [GBIF] Filtrando por reino Plantae (Flora).
#> ℹ [GBIF] Consultando registros dentro del polígono de Unidad seleccionada (límite: "100")...
#> ✔ [GBIF] Búsqueda finalizada. Se filtraron 100 registro(s) que caen dentro del polígono seleccionado.
#> ℹ [iNaturalist] Iniciando búsqueda de ocurrencias...
#> ℹ [iNaturalist] Filtrando por reino Plantae (Flora).
#> ℹ [iNaturalist] Consultando registros dentro de la caja delimitadora de Unidad seleccionada (límite: "100")...
#> ℹ [iNaturalist] Se descargaron 72 registros en la caja delimitadora. Aplicando filtro espacial...
#> ✔ [iNaturalist] Búsqueda finalizada. 72 de 72 registros caen dentro del polígono seleccionado.
...
#>    occurrenceID sourceRecordID sourceURL        datasetKey license basisOfRecord
#>    <chr>        <chr>          <chr>            <chr>      <chr>   <chr>        
#>  1 6273615758   6273615758     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  2 5166843306   5166843306     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  3 5215721628   5215721628     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  4 5230941804   5230941804     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  5 5935225529   5935225529     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  6 6130845716   6130845716     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  7 6178303497   6178303497     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  8 6178484421   6178484421     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#>  9 6178594536   6178594536     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#> 10 6178747062   6178747062     https://www.gbi… 50c9509d-… http:/… HUMAN_OBSERV…
#> # ℹ 162 more rows
#> # ℹ 18 more variables: scientificName <chr>, decimalLatitude <dbl>,
#> #   decimalLongitude <dbl>, eventDate <chr>, taxonRank <chr>, kingdom <chr>,
#> #   phylum <chr>, class <chr>, order <chr>, family <chr>, genus <chr>,
