...
|:---|:---|:---|
| [`buscar_especies_distrito()`](https://paulesantos.github.io/peruocc/reference/buscar_especies_distrito.md) | Búsqueda directa en un distrito oficial | Nombre de distrito + departamento |
| [`buscar_especies_provincia()`](https://paulesantos.github.io/peruocc/reference/buscar_especies_provincia.md) | Búsqueda en una provincia (distritos disueltos) | Nombre de provincia + departamento |
| [`buscar_especies_poligono()`](https://paulesantos.github.io/peruocc/reference/buscar_especies_poligono.md) | Búsqueda en geometrías de usuario / buffers | Objeto `sf` o archivo (`.shp`, `.geojson`) |
| [`buscar_especies_peru()`](https://paulesantos.github.io/peruocc/reference/buscar_especies_peru.md) | Consulta unificada con partición adaptativa | Nivel (`"distrito"` o `"provincia"`) |
| [`obtener_poligono_distrito()`](https://paulesantos.github.io/peruocc/reference/obtener_poligono_distrito.md) | Obtiene la geometría oficial `sf` de un distrito | Nombre de distrito + departamento |
| [`obtener_poligono_provincia()`](https://paulesantos.github.io/peruocc/reference/obtener_poligono_provincia.md) | Obtiene la geometría disuelta `sf` de una provincia | Nombre de provincia + departamento |
| [`graficar_ocurrencias()`](https://paulesantos.github.io/peruocc/reference/graficar_ocurrencias.md) | Visualización cartográfica en `ggplot2` | Objeto devuelto por `buscar_especies_*` |
| [`exportar_resultados()`](https://paulesantos.github.io/peruocc/reference/exportar_resultados.md) | Guarda en disco en formatos CSV, GeoJSON y JSON | Objeto devuelto por `buscar_especies_*` |
| [`peruocc_data_dir()`](https://paulesantos.github.io/peruocc/reference/peruocc_data_dir.md) | Configura ruta central de caché y exportación | Ruta de directorio |
